const triggers = ["Name?", "Alter?", "Land?", "Wohnort?", "Sprachen?", "Beruf?", "Hobby?", "Wie ist Ihr Familienname?", "Können Sie das buchstabieren?","Haben Sie ein Handy?","Wie ist bitte Ihre Nummer?"];


let allTriggerAnswersJSON = `[
    {"Name?" : ["Wie heißt du?", "Ich heiße", "Mein Name ist"],
    "Alter?" : ["Wie alt bist du?", "Ich bin"],
    "Land?" : ["Woher kommst du?", "Ich komme aus", "Ich bin aus", "Mein Land heißt", "Meine Heimat ist"],
    "Wohnort?" : ["Wo wohnst du?", "Ich wohne in", "Ich lebe in"],
